"""
phase_space_integrator.py — Track 5: The Final Exit Gate

EXECUTIVE MANDATE: THE PHASE-SPACE INTEGRATOR (V1.2)

This module performs high-dimensional fusion of SIX signals into a single
IntegratedParticle that lives on a Unit Hypersphere. Distance on this sphere
is the Absolute Metric of Framing Difference.

THE SIX FINGERS:
================
Track 1 (Logits):      The "Surface Claim" — explicit NLI verdict
Track 1.5 (Antagonism): The "Internal Stress" — phase-gate gradient (−cosθ)
Track 2 (Hologram):     The "Terrain" — Matern-projected ZCA-whitened embeddings
Track 3 (Blinker):      The "Static Crack Detector" — Dirichlet variance/entropy
Track 4 (Walker):       The "Kinetic Crack Detector" — MCMC path conductivity
Track 5 (Integration):  THIS MODULE — fuses all above into unit-sphere particle
...
THE ENDOGENOUS LENS:
====================
1. Robust Scaling: 5k-sample normalization equalizes track magnitudes
2. Global ZCA Whitening: Decorrelates tracks to expose hidden cracks
3. Unit-Sphere Projection: L2 normalization for absolute distance metric
